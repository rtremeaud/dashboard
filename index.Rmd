...
subject1 <- read_csv("subject.csv")
subject1$ID<-"W1"
subject2 <- read_csv2("subject.csv")
subject2$ID<-"M1"
subject3 <- read_csv2("subject.csv")
subject2$ID<-"W2"
dd<-merge(subject3, subject2, all = TRUE)
dd<-merge(dd, subject1, all = TRUE)
